interface CenterButtonProps {
  /** Название иконки Material Icons (например: "auto_awesome") */
  icon: string;
  
  /** Большой заголовок кнопки */
  title: string;
  
  /** Описание под заголовком */
  description: string;
  
  /** Текст внутренней кнопки-CTA */
  ctaText: string;
  
  /** Обработчик клика по всей большой кнопке */
  onClick: () => void;
}
    ...
    <div className="w-105 shrink-0 flex items-center justify-center">
      ...
      >
        ...
        <div className="text-center">
          <h2 className="text-3xl font-semibold mb-2 tracking-tight">{title}</h2>
